...
class Themeton_Social_Links_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_html__('Displays your social profile.', 'press-grid')
        );
        parent::__construct(false, esc_html__(': Social Links', 'press-grid'), $widget_ops);
    }
    ...
    function form($instance) {
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title:', 'press-grid'); ?></label>
