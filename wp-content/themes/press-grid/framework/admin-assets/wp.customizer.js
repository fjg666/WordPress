(function($) {
    ...
    $(document).ready(function(){
        ...
        // font_group control
        $('.customizer-font-group-label').each(function(){
            var _this = $(this);
            _this.find('.cfg-handler a').on('click', function(){
                _this.toggleClass('opened-details');
            });

            _this.find('select.customizer-font-family').on('change', function(){
                if( this.value!='default' ){
                    _this.find('.cfg-preview').css('font-family', this.value);
                }
            });
            _this.find('select.customizer-font-style').on('change', function(){
                _this.find('.cfg-preview').css('font-style', this.value);
            });
            _this.find('select.customizer-font-weight').on('change', function(){
                _this.find('.cfg-preview').css('font-weight', this.value);
            });
            _this.find('select.customizer-font-size').on('change', function(){
                _this.find('.cfg-preview').css('font-size', this.value);
            });
            _this.find('select.customizer-line-height').on('change', function(){
                _this.find('.cfg-preview').css('line-height', this.value);
            });
        ...
        wp.media.customizerMediaManager = {
            ...
            init: function() {
                ...
                $('.open-media-manager').click( function( event ) {
                ...
                $('.customizer-media-manager a.remove').click( function( event ) {
