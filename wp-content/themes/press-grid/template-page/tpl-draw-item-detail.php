...
$res = sel_playlist($user_id,$start,$y);
$sum = count(sel_playlist_count($user_id,$start));
?>
          ...
          <div class="col-md-3 sidebar video">
            <div class="entry-sidebar">
              <div class="theiaStickySidebar_video">
                ...
                <?php get_template_part('template-page/tpl-video-nav'); ?>
                    ...
                    <div class="wrapper_video">
                      <div class="video_content" id="video_view">
                        ...
                        <div class="mod_nav_related">
                          <ul class="related_list cf">
                            ...
                            <li class="item current">
                              <a href="<?php echo esc_url(Press_Grid_Static::get_url_video_item() ); ?>" class="link">返回原播单
                                <!-- <i class="nums">4</i> -->
                              </a>
                            </li>
                        ...
                        <div class="filter_bar btn-group-xs">
                          <button type="button" data-vid="<?php echo $start;?>"
                            class="btn btn-info btn-sm _item_video_add">
                              添加视频
                          </button>

                          <button class="btn btn-danger" id="remove_item_detail_btn">移除</button>
                          <input type="hidden" id="mege_type" value="video">
                          <div class="m-modal" id="modal-video-item-create">
                            <div class="m-modal-dialog">
                              ...
                              <div class="m-bottom btn-group-xs">
                                <button class="m-btn-sure btn btn-primary " id="m-btn-sure">
                                    保 存</button>
                        ...
                        <ul class="video_list" id="item_video_list">
...
?>
                            <li class="item_list">
                              <div class="item_a">
                                <input type="checkbox"
                                    name="selectFlag" value="<?php echo $item->id; ?>">
                              </div>
                              <div class="item_b">

                                <a href="./?p=<?php echo $item->post_id;?>" target="_blank" class="img">
<?php 
  $post_image = get_post_thumbnail_id($item->post_id);
...
<img src="<?php echo $image_url; ?>" alt=""/>
                                ...
                                <div class="video_detail">
                                  <h3 class="title">
    <a hot="uc.manage.li.title" href="./?p=<?php echo $item->post_id;?>" target="_blank" >
  ...
  <?php endforeach; ?>
                              ...
                              <div class="item_d">
                                ...
                                <ol class="option_list" style="width: 115px;">
                                  ...
                                  <li class="item">
                                    <a href="<?php echo esc_url(Press_Grid_Static::get_url_video_edit($item->post_id));?>" 
                                      class="btn_normal" >
                                      <i class="icon_edited"></i>
                                      <span class="inner">编辑</span>
                                    </a>

                                    <a href="javascript:" class="btn_normal _remove_item_detail" 

                                      data-vid="<?php echo $item->id; ?>" data-status="2">

                                      <i class="icon_delete"></i>
                                      <span class="inner">移除</span>
                                    </a>
                                  </li>

                                  <!-- <li class="item">
                                    <a href="javascript:" class="btn_normal _del_video" data-vid="b0329rbnorw" _hot="uc.manage.li.cover">
        <i class="icon_add"></i>
        <span class="inner">移除</span>
      </a>
                                  </li> -->
...
?>
                            ...
                            <li class="page-item <?php echo $active;?>"> 
                              <a href="?pagename=video-item-detail&c=<?php echo $start;?>&y=<?php echo $i-1;?>" 
...
$page_next_str = '<a class="page-link" href="?pagename=video-item-detail&c='.$start.'&y=';
...
<div class="m-modal " id="modal-item-video-add" >
  <div class="m-modal-dialog" >
    ...
    <div class="m-middle" style="padding-right:0">
