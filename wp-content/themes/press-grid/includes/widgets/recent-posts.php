...
class Themeton_Recent_Posts_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'latest_blogs', 'description' => esc_html__('Recent posts.', 'press-grid') );
        parent::__construct(false, esc_html__(': Recent Posts', 'press-grid'), $widget_ops);
    }
        ...
        while ( $posts_query->have_posts() ) {
            ...
            if($style != 'yes') {
                ...
                if( $post_index==1 || $post_index==2 ){
                    $thumb_img = sprintf('<img src="%s/images/1x1.png" alt="'.esc_attr__('Thumb', 'press-grid').'">', get_template_directory_uri());
                    ...
                    $post_items .= sprintf('<div class="fs-rp-item">
                                            ...
                                            get_the_title(), esc_html__('read the article', 'press-grid') );
                }
                else{
                ...
                $thumb_img = sprintf('<div class="image image-thumb"><img src="%s/images/1x1.png" alt="'.esc_attr__('Thumb', 'press-grid').'"></div>', get_template_directory_uri());
                if( has_post_thumbnail() ){
